...
#if ( defined(CYW20819A1) || defined(CYW20829A0LKML) || defined (CYW20829B0LKML) || defined (CYW89829B01MKSBG))
...
const char *app_get_gatt_status_name(wiced_bt_gatt_status_t status)
{
    ...
    default:
        return "WICED_BT_GATT_INVALID_CONNECTION_ID";
    }
}
/*******************************************************************************
